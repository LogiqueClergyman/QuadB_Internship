...
function Register() {
  ...
  return (
    <div className="h-screen">
      <form class="max-w-xl mx-auto p-10">
        <div class="grid md:grid-cols-2 md:gap-6">
          <div class="relative z-0 w-full mb-5 group">
            <input
              ...
              value={formData.name}
              class="block py-2.5 px-0 w-full  font-semibold text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-white peer"
              placeholder=" "
              required
            />
            <label
        ...
        <div class="relative z-0 w-full mb-5 group">
          <input
            ...
            name="floating_email"
            id="floating_email"
            class="block py-2.5 px-0 w-full  font-semibold text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-white peer"
            placeholder=" "
            required
          />
          <label
        ...
        <button
          type="submit"
          class="text-black hover:text-white bg-white hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center "
        >
          Submit
        </button>
      </form>
